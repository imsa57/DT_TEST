...
const data = apiData[0].tasks[0];

const content = document.querySelector(".content_heading_box");
...
content.insertAdjacentHTML("afterend", heading_content);
// console.log(data);
...
data?.assets.map((item, index) => {
  if (item.asset_content.trim()) {
    document.querySelectorAll(".card")[index].insertAdjacentHTML(
      "afterbegin",
      ` <div class="card_heading">
    <h5>${item.asset_title}</h5>
    <img src="./assets/Group 1736.png" alt="" />
    </div>
